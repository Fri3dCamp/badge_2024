...
This are the main differences between v8.x and v9.x [Changelog](https://docs.lvgl.io/9.0/CHANGELOG.html) and more specific [api-changes](https://docs.lvgl.io/9.0/CHANGELOG.html#general-api-changes)
