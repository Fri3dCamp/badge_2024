...
Dit zijn de belangrijkste verschillen tussen v8.x en v9.x [Changelog](https://docs.lvgl.io/9.0/CHANGELOG.html)  
en meer specifiek [api-changes](https://docs.lvgl.io/9.0/CHANGELOG.html#general-api-changes)
