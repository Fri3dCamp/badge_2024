...
Om de [LANA](https://phyx.be/LANA_TNY/) module op je `blaster` (flamingo) te programmeren, kun je zowel [Embeetle IDE](https://embeetle.com/) als [Mounriver Studio](http://www.mounriver.com/) gebruiken.
...
&nbsp;<br>
Selecteer vervolgens `WCH` als chip fabrikant en zoek naar het project `lana-tny-01-blaster-2024`:
...
Belangrijk: je badge mag niet aangesloten zijn aan de `blaster` (flamingo) (5V van de USB maakt je 3,3V badge stuk)  
...
Als je zelf aan de slag gaat met de blaster/LANA TNY, moet je op één ding letten (ongeacht de IDE): LANA heeft geen externe klok en moet de interne klok (HSI) gebruiken, dit wordt ook vermeld in de standaard sketch van [Embeetle](https://embeetle.com/).
